                ...
                <aside className="space-y-5 px-5 py-5">
                  {eventChatCandidates.length > 0 && (
                    <div className="rounded-[22px] border border-[#2A2D3E] bg-[#10141E] p-4">
                      <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-gray-500">Créer un groupe évènement</p>
                          ...
                          return (
                            <div key={eventKey} className="rounded-2xl border border-[#2A2D3E] bg-[#0F1117] p-3">
                              ...
                              {existingGroup ? (
                                ...
                                >
                                  {chatUnavailable ? 'Bientôt disponible' : groupBusyKey === eventKey ? 'Création...' : 'Créer le groupe'}
                                </button>
                              )}
                            </div>
                          )
